...
def lbp_calculated_pixel(img, x, y):
    ...
    #           get_pixel(img, center, x, y + 1), get_pixel(img, center, x + 1, y - 1),
    #           get_pixel(img, center, x+1, y), get_pixel(img, center, x+1, y + 1)]
...
if __name__ == '__main__':
    ...
    image_path = "C:\\Users\\Marcel\\Downloads\\face_anti-spoofing\\face_anti-spoofing\\imgs_validation\\real\\30-1-image1-test.jpeg"
    model_path = "C:\\Users\\Marcel\\Desktop\\code\\tugas-akhir\\spoofing-detection\\dataset\\model\\model2.pkl"
    ...
    if face_locations:  # jika terdeteksi wajah
        for top, right, bottom, left in face_locations:
            ...
            result_image = cv2.rectangle(result_image, (left, top), (right, bottom), (255, 0, 0), 2)
            face_image = cv2.cvtColor(face_image, cv2.COLOR_BGR2GRAY)
            face_image = cv2.resize(face_image, (256, 256))

            print(face_image, type(face_image), end=" = face_image\n\n")
            # lbp
            ...
            print(lbp_image, type(lbp_image), end=" = lbp_image\n\n")
    ...
    #
    while True:
        cv2.imshow("Space to quit", lbp_image)
